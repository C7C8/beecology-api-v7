...
relative_frequencies_parser.add_argument("x-bin-cutoffs", type=float, help="List of X variable cutoffs as timestamps to bin the X axis by (at least 3)", action="split", required=True)
