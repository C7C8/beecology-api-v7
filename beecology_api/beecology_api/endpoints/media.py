...
# from beecology_api.db import Media as DBMedia
...
# 		id, file_path, web_path = _process_media(b64=args["data"], mime_type="image", max_size=10**7)
# 		image = DBMedia(id=id, file_path=file_path, web_path=web_path)
